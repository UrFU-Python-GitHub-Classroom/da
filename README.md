...
Файл с заданиями [tasks.ipynb](tasks.ipynb) можно открыть в [Google Colab](https://colab.research.google.com/) -> Файл -> Открыть блокнот -> GitHub -> Указать путь до Вашего репозитория -> Выбрать блокнот

Для выполнения заданий понадобится добавить в "Файлы" проекта [works.csv](works.csv)

Выполнение задания сохранить в этот репозиторий
